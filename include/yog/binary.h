 ...
 */
/* src/binary.c */
YOG_EXPORT void YogBinary_add(YogEnv*, YogVal, const char*, uint_t);
YOG_EXPORT void YogBinary_define_classes(YogEnv*, YogVal);
YOG_EXPORT YogVal YogBinary_new(YogEnv*);
YOG_EXPORT YogVal YogBinary_of_size(YogEnv*, uint_t);
YOG_EXPORT void YogBinary_push_char(YogEnv*, YogVal, char);
YOG_EXPORT void YogBinary_push_id(YogEnv*, YogVal, ID);
YOG_EXPORT void YogBinary_push_pc(YogEnv*, YogVal, pc_t);
YOG_EXPORT void YogBinary_push_uint(YogEnv*, YogVal, uint_t);
...
YOG_EXPORT YogVal YogBinary_to_s(YogEnv*, YogVal, YogVal);
