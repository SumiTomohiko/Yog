...
YOG_EXPORT YogVal YogTable_create_string_table(YogEnv*);
YOG_EXPORT YogVal YogTable_create_symbol_table(YogEnv*);
YOG_EXPORT YogVal YogTable_create_value_table(YogEnv*);
