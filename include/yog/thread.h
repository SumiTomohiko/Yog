...
void YogThread_config_generational(YogEnv*, YogVal, size_t, size_t, uint_t);
void YogThread_config_mark_sweep(YogEnv*, YogVal, size_t);
void YogThread_config_mark_sweep_compact(YogEnv*, YogVal, size_t);
void YogThread_define_classes(YogEnv*, YogVal);
YogVal YogThread_get_c_frame(YogEnv*, YogVal);
YogVal YogThread_get_finish_frame(YogEnv*, YogVal);
YogVal YogThread_get_script_frame(YogEnv*, YogVal);
void YogThread_init(YogEnv*, YogVal, YogVal);
void YogThread_issue_object_id(YogEnv*, YogVal, YogVal);
YogVal YogThread_new(YogEnv*);
void YogThread_put_c_frame(YogEnv*, YogVal, YogVal);
void YogThread_put_finish_frame(YogEnv*, YogVal, YogVal);
void YogThread_put_script_frame(YogEnv*, YogVal, YogVal);
