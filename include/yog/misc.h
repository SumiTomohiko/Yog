 ...
 */
/* src/misc.c */
void YogMisc_check_Encoding(YogEnv*, YogHandle*, const char*);
void YogMisc_check_Fixnum(YogEnv*, YogHandle*, const char*);
void YogMisc_check_Fixnum_optional(YogEnv*, YogHandle*, const char*);
...
LIB_HANDLE YogMisc_load_lib(YogEnv*, YogHandle*);
