 ...
 */
/* src/misc.c */
YOG_EXPORT void YogMisc_check_Encoding(YogEnv*, YogHandle*, const char*);
YOG_EXPORT void YogMisc_check_Fixnum(YogEnv*, YogHandle*, const char*);
YOG_EXPORT void YogMisc_check_Fixnum_optional(YogEnv*, YogHandle*, const char*);
