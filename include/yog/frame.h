...
void YogFinishFrame_clean(YogEnv*, YogVal);
YogVal YogFinishFrame_new(YogEnv*);
YogVal YogFrame_get_c_frame(YogEnv*);
YogVal YogFrame_get_script_frame(YogEnv*, YogVal, uint_t);
void YogScriptFrame_cleanup(YogEnv*, YogVal);
YogVal YogScriptFrame_new(YogEnv*, YogFrameType, YogVal, uint_t, uint_t);
