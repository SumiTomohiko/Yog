...
YOG_EXPORT int YogBignum_compare_with_int(YogEnv*, YogVal, int_t);
YOG_EXPORT int YogBignum_compare_with_long(YogEnv*, YogVal, long);
YOG_EXPORT int_t YogBignum_compare_with_long_long(YogEnv*, YogVal, long long);
YOG_EXPORT int YogBignum_compare_with_unsigned_int(YogEnv*, YogVal, uint_t);
YOG_EXPORT int YogBignum_compare_with_unsigned_long(YogEnv*, YogVal, unsigned long);
...
YOG_EXPORT long YogBignum_to_long(YogEnv*, YogVal, const char*);
...
YOG_EXPORT unsigned long YogBignum_to_unsigned_long(YogEnv*, YogVal, const char*);
