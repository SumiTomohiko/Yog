...
add_inst(YogEnv* env, YogVal data, YogVal inst)
{
    ...
    YogGC_UPDATE_PTR(COMPILE_DATA(data), last_inst, inst);
}
...
TryListEntry_new(YogEnv* env, YogVal node)
{
    ...
    YogGC_UPDATE_PTR(PTR_AS(TryListEntry, ent), node, node);
...
CompileData_push_try(YogEnv* env, YogVal data, YogVal node)
{
    ...
    YogGC_UPDATE_PTR(TRY_LIST_ENTRY(ent), prev, COMPILE_DATA(data)->try_list);
    YogGC_UPDATE_PTR(COMPILE_DATA(data), try_list, ent);
...
CompileData_pop_try(YogEnv* env, YogVal data)
{
    ...
    YogGC_UPDATE_PTR(COMPILE_DATA(data), try_list, TRY_LIST_ENTRY(ent)->prev);
...
compile_visit_stmt(YogEnv* env, AstVisitor* visitor, YogVal stmt, YogVal data)
{
    ...
    YogGC_UPDATE_PTR(COMPILE_DATA(data), cur_stmt, stmt);
...
make_var_table(YogEnv* env, YogVal params, YogVal stmts, YogVal var_tbl)
{
    ...
    YogGC_UPDATE_PTR(SCAN_VAR_DATA(data), var_tbl, var_tbl);
...
register_const(YogEnv* env, YogVal data, YogVal const_)
{
    ...
    if (!IS_PTR(const2index)) {
        ...
        YogGC_UPDATE_PTR(COMPILE_DATA(data), const2index, const2index);
    }
...
make_exception_table(YogEnv* env, YogVal code, YogVal data)
{
    ...
    if (0 < size) {
        ...
        YogGC_UPDATE_PTR(CODE(code), exc_tbl, exc_tbl);
...
make_lineno_table(YogEnv* env, YogVal code, YogVal anchor)
{
    ...
    YogGC_UPDATE_PTR(CODE(code), lineno_tbl, tbl);
...
CompileData_new(YogEnv* env, Context ctx, YogVal vars, YogVal anchor, YogVal exc_tbl_ent, YogVal filename, ID class_name, YogVal upper_data, BOOL interactive)
{
    ...
    YogGC_UPDATE_PTR(COMPILE_DATA(data), vars, vars);
    ...
    YogGC_UPDATE_PTR(COMPILE_DATA(data), last_inst, anchor);
    YogGC_UPDATE_PTR(COMPILE_DATA(data), exc_tbl, exc_tbl_ent);
    YogGC_UPDATE_PTR(COMPILE_DATA(data), exc_tbl_last, exc_tbl_ent);
    YogGC_UPDATE_PTR(COMPILE_DATA(data), filename, filename);
    COMPILE_DATA(data)->class_name = class_name;
    YogGC_UPDATE_PTR(COMPILE_DATA(data), outer, upper_data);
...
AllocLocalVarsTableArg_new(YogEnv* env, YogVal names, uint_t count)
{
    ...
    YogGC_UPDATE_PTR(PTR_AS(AllocLocalVarsTableArg, arg), names, names);
...
static YogVal
compile_stmts(YogEnv* env, AstVisitor* visitor, YogVal filename, ID class_name, ID func_name, YogVal params, YogVal stmts, YogVal vars, Context ctx, YogVal upper_data, BOOL interactive)
{
    SAVE_ARGS5(env, filename, params, stmts, vars, upper_data);
    ...
    YogGC_UPDATE_PTR(CODE(code), consts, consts);
    YogGC_UPDATE_PTR(CODE(code), insts, PTR_AS(YogBinary, bin)->body);
    ...
    YogGC_UPDATE_PTR(CODE(code), filename, filename);
...
setup_params(YogEnv* env, YogVal vars, YogVal params, YogVal code)
{
    ...
    YogGC_UPDATE_PTR(CODE(code), arg_info, arg_info);
    ...
    YogGC_UPDATE_PTR(ARG_INFO(arg_info), argnames, argnames);
    if (size == argc) {
        RETURN_VOID(env);
    }
...
compile_func(YogEnv* env, AstVisitor* visitor, YogVal filename, ID class_name, YogVal node, YogVal upper)
{
    ...
    YogVal code = compile_stmts(env, visitor, filename, class_name, func_name, params, stmts, vars, CTX_FUNC, upper, FALSE);
    PUSH_LOCAL(env, code);
...
compile_visit_finally(YogEnv* env, AstVisitor* visitor, YogVal node, YogVal data)
{
    ...
    YogGC_UPDATE_PTR(FINALLY_LIST_ENTRY(finally_list_entry), prev, COMPILE_DATA(data)->finally_list);
    YogGC_UPDATE_PTR(COMPILE_DATA(data), finally_list, finally_list_entry);
    YogGC_UPDATE_PTR(FINALLY_LIST_ENTRY(finally_list_entry), node, node);
    ...
    YogGC_UPDATE_PTR(TRY_LIST_ENTRY(try_list_entry), exc_tbl, exc_tbl_entry);
    ...
    YogGC_UPDATE_PTR(COMPILE_DATA(data), finally_list, FINALLY_LIST_ENTRY(finally_list_entry)->prev);
...
compile_visit_while(YogEnv* env, AstVisitor* visitor, YogVal node, YogVal data)
{
    ...
    YogGC_UPDATE_PTR(COMPILE_DATA(data), label_while_start, while_start);
    YogGC_UPDATE_PTR(COMPILE_DATA(data), label_while_end, while_end);
    ...
    YogGC_UPDATE_PTR(COMPILE_DATA(data), label_while_end, label_while_end_prev);
    YogGC_UPDATE_PTR(COMPILE_DATA(data), label_while_start, label_while_start_prev);
...
compile_block(YogEnv* env, AstVisitor* visitor, YogVal node, YogVal data)
{
    ...
    code = compile_stmts(env, visitor, filename, class_name, func_name, params, stmts, vars, CTX_BLOCK, data, FALSE);
...
compile_class(YogEnv* env, AstVisitor* visitor, ID class_name, YogVal stmts, uint_t first_lineno, YogVal data)
{
    ...
    YogVal code = compile_stmts(env, visitor, filename, class_name, func_name, YUNDEF, stmts, vars, CTX_CLASS, COMPILE_DATA(data)->outer, FALSE);
...
compile_module(YogEnv* env, AstVisitor* visitor, ID name, YogVal stmts, uint_t lineno, YogVal data)
{
    ...
    code = compile_stmts(env, visitor, filename, class_name, func_name, YUNDEF, stmts, vars, CTX_MODULE, COMPILE_DATA(data)->outer, FALSE);
...
compile_package(YogEnv* env, const char* filename, YogVal stmts, BOOL interactive)
{
    ...
    YogVal code = compile_stmts(env, &visitor, name, class_name, func_name, YUNDEF, stmts, vars, CTX_PKG, YUNDEF, interactive);
